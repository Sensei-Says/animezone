// Определяем типы локально для избежания проблем с импортом
export type VideoQuality = 0 | 144 | 240 | 360 | 480 | 720 | 1080;
export type VideoType = "mp4" | "m3u8" | "mpd" | "audio" | "webm";
